...
class Spot:
    ...
    def is_barrier(self):
        return (
            ...
            or self.color == LBLUE
            or self.color == LGREY
            or self.color == ROBOT1
            or self.color == ROBOT2
            or self.color == ROBOT3
            or self.color == ROBOT4
            or self.color == ROBOT5
            or self.color == ROBOT6
        )
...
def reconstruct_path2(came_from, current, draw, robotNo, final, begin):
...
def algorithm2(thread_name, draw, grid, start, end, robotNo):
    ...
    while not open_set.empty():
        ...
        if current == end:
            reconstruct_path2(came_from, end, draw, robotNo, end, start)
            return True
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if (
                    ...
                    # time.sleep(0.1)
                    start1 = end[final[0] - 1]
                    start2 = end[final[1] - 1]
                    start3 = end[final[2] - 1]
